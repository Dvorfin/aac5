...
configurations = {
    1:
        [Server(server_id=1, bu_power=1.22, bandwidth_bytes=10000),
        ...
        Server(server_id=9, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=10, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=11, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=12, bu_power=1.22, bandwidth_bytes=10000),],
    2:
        [Server(server_id=1, bu_power=1, bandwidth_bytes=10000),
        ...
        Server(server_id=10, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=11, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=12, bu_power=2.2, bandwidth_bytes=10000),],
    3:
        [Server(server_id=1, bu_power=1, bandwidth_bytes=10000),
        Server(server_id=2, bu_power=1, bandwidth_bytes=10000),
        Server(server_id=3, bu_power=1, bandwidth_bytes=10000),
    ...
    4:
        ...
        Server(server_id=4, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=5, bu_power=1.22, bandwidth_bytes=10000),
        Server(server_id=6, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=7, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=8, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=9, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=10, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=11, bu_power=2.2, bandwidth_bytes=10000),
        Server(server_id=12, bu_power=2.2, bandwidth_bytes=10000),],
}
...
#
    ...
    task_size = 20
    tasks_per_second = 10  # 5 задач в секунду
