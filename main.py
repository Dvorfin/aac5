    ...
    with open(filename, mode='w', newline='') as file:
        ...
        for server in servers:
            ...
            writer.writerow({
                ...
                'Weighted Load (%)': round(weighted_load, 4),
                'Weighted Network Load (%)': round(weighted_network, 4),
                'Weighted Tasks Load (pieces)': round(weighted_tasks, 4),
                'Work time (%)': round(server.total_work_time),
...
configurations = {
    1:
        [Server(server_id=1, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=2, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=3, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=4, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=5, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=6, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=7, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=8, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=9, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=10, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=11, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=12, bu_power=1.22, bandwidth_bytes=20000),],
    2:
        [Server(server_id=1, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=2, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=3, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=4, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=5, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=6, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=7, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=8, bu_power=1.22, bandwidth_bytes=20000),
        ...
        Server(server_id=10, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=11, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=12, bu_power=2.2, bandwidth_bytes=20000),],
    3:
        [Server(server_id=1, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=2, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=3, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=4, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=5, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=6, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=7, bu_power=1, bandwidth_bytes=20000),
        Server(server_id=8, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=9, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=10, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=11, bu_power=1.22, bandwidth_bytes=20000),
    ...
    4:
        ...
        Server(server_id=4, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=5, bu_power=1.22, bandwidth_bytes=20000),
        Server(server_id=6, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=7, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=8, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=9, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=10, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=11, bu_power=2.2, bandwidth_bytes=20000),
        Server(server_id=12, bu_power=2.2, bandwidth_bytes=20000),],
}
